...
const Home = () => {
  return (
    <div className='text-white pt-10 md:flex md:flex-row-reverse md:gap-3 md:items-start md:mt-24 md:h-auto md:pt-0'>
      ...
      <div className='md:w-1/2'>
        <h1 className='hidden md:block text-[8vw] font-bold mb-10 md:text-5xl text-center'>Tuto Mentor</h1>
          ...
          <button className='text-primary text-6xl md:text-3xl rounded-full font-bold text-center
